...
// composeTestRule.onNodeWithText(composeTestRule.activity.getString(R.string.my_string) envez de esto
// esto composeTestRule.onNodeWithStringId(R.string.my_string)